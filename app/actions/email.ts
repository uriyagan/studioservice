...
const SAMPLE_VARS: Record<string, string> = {
  ...
  task_time: "1 שעות 30 דקות",
  task_url: "https://service.uriyaganor.com/admin",
  set_password_link: "https://service.uriyaganor.com/set-password",
  message: "זו הודעת דוגמה בגוף השיחה.",
  tasks_summary: "עיצוב באנר — 1 שעות 30 דקות · ניסוח טקסט — 45 דקות",
  hours_used: "5 שעות",
  hours_remaining: "5 שעות",
  total_hours: "10 שעות",
  hours_added: "5 שעות",
